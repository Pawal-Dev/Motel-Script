...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Display.Glare = Config.EffetBanniere;
    ...
    Menu.Index = 1
    Menu.Sprite = { Dictionary = TextureDictionary or Config.Banniere.ytdname, Texture = TextureName or Config.Banniere.nameimage, Color = { R = R, G = G, B = B, A = A } }
    Menu.Rectangle = nil
...
function RageUI.Menus:EditSpriteColor(R, G, B, A)
    if self.Sprite.Dictionary == Config.Banniere.ytdname then
...
function RageUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or Config.Banniere.ytdname, Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

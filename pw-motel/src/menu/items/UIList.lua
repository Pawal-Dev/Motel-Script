...
local SettingsButton = {
    ...
    SelectedSprite = { Dictionary = "Config.Banniere.ytdname", Texture = "gradient_nav", Y = 0, Width = 431, Height = 38 },
}

---@type table
local SettingsList = {
    LeftArrow = { Dictionary = "Config.Banniere.ytdname", Texture = "arrowleft", X = 378, Y = 3, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "Config.Banniere.ytdname", Texture = "arrowright", X = 400, Y = 3, Width = 30, Height = 30 },
